...
const details = document.querySelector('.details'); //deatails 요소 저장
 ...
 current.forEach((item) => {
    ...
    if(bounds.hasLatLng(latLng)){
      ...
      let infoWindow = new naver.maps.InfoWindow({
        content: `
         <h4 style="padding:0.25rem; font-size:14px; font-weight:normal;
         color:#fff; background:#222; border-radius:6px;">${item.도서관명}</h4>
       `,
      });
